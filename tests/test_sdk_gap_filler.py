...
# ===========================================================================
# eval_.py: EvalScenarioStartedPayload + EvalScenarioCompletedPayload (150, 152, 195)
# ===========================================================================
...
class TestAgentRunTotalToolCallsRaise:
    def test_negative_total_tool_calls_raises(self) -> None:
        ...
        from tracium.namespaces.trace import (
            AgentRunPayload, CostBreakdown, TokenUsage,
        )
        t0 = int(time.time_ns())
        t1 = t0 + 1_000_000
...
class TestExceptionLines:
    def test_schema_version_error_instantiation(self) -> None:
        ...
        from tracium.exceptions import SchemaVersionError
