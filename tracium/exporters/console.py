"""tracium.exporters.console — Human-readable development console exporter.
...
class SyncConsoleExporter:
    ...
    used, which is the default if ``TRACIUM_EXPORTER`` is not set.
    """
    ...
    def export(self, event: Event) -> None:
        ...
        Args:
            event: A :class:`~tracium.event.Event` instance.
        """
