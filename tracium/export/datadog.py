"""tracium.export.datadog — Datadog trace/metric exporter.

Delivers Tracium events to the **Datadog Agent** (trace intake on
...
class DatadogExporter:
    """Async exporter that sends Tracium events to Datadog.
