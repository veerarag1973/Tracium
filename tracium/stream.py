...
:class:`~tracium.event.Event` objects with a fluent API for filtering and
...
class Exporter(Protocol):
    ...
    All built-in exporters (:class:`~tracium.export.otlp.OTLPExporter`,
...
class EventStream:
    """An immutable, ordered sequence of :class:`~tracium.event.Event` objects.
    ...
    def from_file(
        ...
        *,
        ...
        :meth:`~tracium.event.Event.from_json`.  Lines that fail to
        deserialize are skipped when ``skip_errors=True``; by default they
        raise :class:`~tracium.exceptions.DeserializationError`.
        ...
        *,
        ...
        Args:
            q:        A :class:`queue.Queue` containing
                      :class:`~tracium.event.Event` objects.
    ...
    def from_kafka(
        ...
        *,
        ...
        parsed with :meth:`~tracium.event.Event.from_json`.
...
def iter_file(
    ...
    *,
    ...
    Yields:
        Parsed :class:`~tracium.event.Event` instances.
...
async def aiter_file(
    ...
    *,
    ...
    yielding one :class:`~tracium.event.Event` at a time.
