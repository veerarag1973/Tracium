"""tracium.compliance.test_chain — HMAC audit-chain integrity verification.

Provides a high-level API over :mod:`tracium.signing` to check that an ordered
...
class ChainIntegrityResult:
    ...
    Attributes:
        ...
        chain_result:    The low-level :class:`~tracium.signing.ChainVerificationResult`,
...
def _check_monotonic_timestamps(
    ...
    Args:
        events: Ordered sequence of :class:`~tracium.event.Event` objects.

    Returns:
        List of :class:`ChainIntegrityViolation` with
        ``violation_type="non_monotonic_timestamp"``.
    """
    from tracium.event import _parse_timestamp  # noqa: PLC0415
...
def verify_chain_integrity(
    ...
    *,
    ...
    """
    from tracium.signing import verify, verify_chain  # noqa: PLC0415
