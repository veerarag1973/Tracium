...
::
    ...
    from tracium.migrate import v1_to_v2, MigrationResult
    ...
    from tracium.migrate import v2_migration_roadmap, DeprecationRecord
...
def v1_to_v2(event: Event) -> tuple[Event, MigrationResult]:
    ...
    Args:
        event: A v1.x :class:`~tracium.event.Event` to migrate.
