"""Schema governance policies for agentobsema events.
...
Typical usage::
    ...
    from agentobs.governance import EventGovernancePolicy, GovernanceViolationError
    ...
    from agentobs.governance import set_global_policy, check_event
...
class EventGovernancePolicy:
    ...
    3. **Custom rules** — callables that receive the :class:`~agentobs.event.Event`
    ...
    def check_event(self, event: Event) -> None:
        ...
        if self.strict_unknown:
            from agentobs.types import is_registered  # noqa: PLC0415
    ...
    def add_rule(self, rule: Callable[[Event], str | None]) -> None:
        ...
        Args:
            rule: A callable that accepts an :class:`~agentobs.event.Event`
