"""agentobs.integrations — Third-party provider and framework integrations.
...
----------------------
* :mod:`agentobs.integrations.openai`    — OpenAI chat completions (Phase 6)
* :mod:`agentobs.integrations.anthropic` — Anthropic Claude (Phase 7)
* :mod:`agentobs.integrations.ollama`    — Ollama local models (Phase 7)
* :mod:`agentobs.integrations.groq`      — Groq API (Phase 7)
* :mod:`agentobs.integrations.together`  — Together AI (Phase 7)
"""
